export default function Item({ name, quantity, category }) {
    return (
        <li className="bg-gray-600 p-2 m-2 rounded flex w-1/3 sm:w-max border-2 border-gray-900 hover:border-white">
            <div className="w-full pr-4 border-r border-gray-400 flex items-center">
                <h2 className="font-bold text-2xl hover:tx">{name}</h2>
            </div>
